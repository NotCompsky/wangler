...
if __name__ == "__main__":
	...
	srcs:list = [args.src + os.sep + fname for fname in os.listdir(args.src)]
	
	if os.path.isfile(args.dst) and os.path.getmtime(args.dst) > max([os.path.getmtime(__file__)]+[os.path.getmtime(fp) for fp in srcs]):
		# Already generated
		exit(0)
